...
namespace ByrneLabs.Commons
{
    ...
    public static class ReflectionHelper
    {
        ...
        public static bool IsSimple(Type type) => _simpleTypes.Contains(type) || type.GetTypeInfo().IsEnum || type.IsArray && IsSimple(type.GetElementType()) || typeof(IEnumerable<>).GetTypeInfo().IsAssignableFrom(type) && IsSimple(type.GetTypeInfo().GetGenericArguments()[0]);
