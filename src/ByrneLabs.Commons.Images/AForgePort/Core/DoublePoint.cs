...
namespace ByrneLabs.Commons.Images.AForgePort.Core
{
    /// <summary>
    ...
    public struct DoublePoint
    {
        ...
        /// 
        public static DoublePoint Add(DoublePoint point1, DoublePoint point2) => new DoublePoint(point1.X + point2.X, point1.Y + point2.Y);
        ...
        /// 
        public static DoublePoint Add(DoublePoint point, double valueToAdd) => new DoublePoint(point.X + valueToAdd, point.Y + valueToAdd);
        ...
        /// 
        public static DoublePoint Divide(DoublePoint point, double factor) => new DoublePoint(point.X / factor, point.Y / factor);
        ...
        ///
        public static DoublePoint Multiply(DoublePoint point, double factor) => new DoublePoint(point.X * factor, point.Y * factor);
        ...
        /// coordinates of specified points.</returns>
        /// 
        public static DoublePoint operator +(DoublePoint point1, DoublePoint point2) => new DoublePoint(point1.X + point2.X, point1.Y + point2.Y);
        ...
        /// the specified point increased by specified value.</returns>
        /// 
        public static DoublePoint operator +(DoublePoint point, double valueToAdd) => new DoublePoint(point.X + valueToAdd, point.Y + valueToAdd);
        ...
        /// the specified point divided by specified value.</returns>
        /// 
        public static DoublePoint operator /(DoublePoint point, double factor) => new DoublePoint(point.X / factor, point.Y / factor);
        ...
        /// 
        public static explicit operator IntPoint(DoublePoint point) => new IntPoint((int)point.X, (int)point.Y);
        ...
        /// 
        public static explicit operator Point(DoublePoint point) => new Point((float)point.X, (float)point.Y);
        ...
        /// 
        public static DoublePoint operator -(DoublePoint point, double valueToSubtract) => new DoublePoint(point.X - valueToSubtract, point.Y - valueToSubtract);
        ...
        /// coordinates of specified points.</returns>
        ///
        public static DoublePoint Subtract(DoublePoint point1, DoublePoint point2) => new DoublePoint(point1.X - point2.X, point1.Y - point2.Y);
        ...
        /// the specified point decreased by specified value.</returns>
        /// 
        public static DoublePoint Subtract(DoublePoint point, double valueToSubtract) => new DoublePoint(point.X - valueToSubtract, point.Y - valueToSubtract);
        ...
        /// 
        public double EuclideanNorm() => Math.Sqrt(X * X + Y * Y);
