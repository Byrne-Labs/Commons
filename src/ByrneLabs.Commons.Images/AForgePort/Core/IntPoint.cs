...
namespace ByrneLabs.Commons.Images.AForgePort.Core
{
    ...
    public struct IntPoint
    {
        ...
        /// 
        public static IntPoint Add(IntPoint point1, IntPoint point2) => new IntPoint(point1.X + point2.X, point1.Y + point2.Y);
        ...
        /// 
        public static IntPoint Add(IntPoint point, int valueToAdd) => new IntPoint(point.X + valueToAdd, point.Y + valueToAdd);
        ...
        /// 
        public static IntPoint Divide(IntPoint point, int factor) => new IntPoint(point.X / factor, point.Y / factor);
        ...
        ///
        public static IntPoint Multiply(IntPoint point, int factor) => new IntPoint(point.X * factor, point.Y * factor);
        ...
        /// coordinates of specified points.</returns>
        /// 
        public static IntPoint operator +(IntPoint point1, IntPoint point2) => new IntPoint(point1.X + point2.X, point1.Y + point2.Y);
        ...
        /// the specified point increased by specified value.</returns>
        /// 
        public static IntPoint operator +(IntPoint point, int valueToAdd) => new IntPoint(point.X + valueToAdd, point.Y + valueToAdd);
        ...
        /// the specified point divided by specified value.</returns>
        /// 
        public static IntPoint operator /(IntPoint point, int factor) => new IntPoint(point.X / factor, point.Y / factor);
        ...
        /// 
        public static implicit operator Point(IntPoint point) => new Point(point.X, point.Y);
        ...
        /// 
        public static IntPoint operator -(IntPoint point, int valueToSubtract) => new IntPoint(point.X - valueToSubtract, point.Y - valueToSubtract);
        ...
        /// coordinates of specified points.</returns>
        ///
        public static IntPoint Subtract(IntPoint point1, IntPoint point2) => new IntPoint(point1.X - point2.X, point1.Y - point2.Y);
        ...
        /// the specified point decreased by specified value.</returns>
        /// 
        public static IntPoint Subtract(IntPoint point, int valueToSubtract) => new IntPoint(point.X - valueToSubtract, point.Y - valueToSubtract);
        ...
        /// 
        public float EuclideanNorm() => (float)Math.Sqrt(X * X + Y * Y);
