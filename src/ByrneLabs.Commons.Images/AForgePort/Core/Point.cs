...
namespace ByrneLabs.Commons.Images.AForgePort.Core
{
    ...
    public struct Point
    {
        ...
        /// 
        public static Point Add(Point point, float valueToAdd) => new Point(point.X + valueToAdd, point.Y + valueToAdd);
        ...
        /// 
        public static Point Divide(Point point, float factor) => new Point(point.X / factor, point.Y / factor);
        ...
        ///
        public static Point Multiply(Point point, float factor) => new Point(point.X * factor, point.Y * factor);
        ...
        /// the specified point increased by specified value.</returns>
        /// 
        public static Point operator +(Point point, float valueToAdd) => new Point(point.X + valueToAdd, point.Y + valueToAdd);
        ...
        /// the specified point divided by specified value.</returns>
        /// 
        public static Point operator /(Point point, float factor) => new Point(point.X / factor, point.Y / factor);
        ...
        /// 
        public static explicit operator IntPoint(Point point) => new IntPoint((int)point.X, (int)point.Y);
        ...
        /// 
        public static implicit operator DoublePoint(Point point) => new DoublePoint(point.X, point.Y);
        ...
        /// 
        public static Point operator -(Point point, float valueToSubtract) => new Point(point.X - valueToSubtract, point.Y - valueToSubtract);
        ...
        /// the specified point decreased by specified value.</returns>
        /// 
        public static Point Subtract(Point point, float valueToSubtract) => new Point(point.X - valueToSubtract, point.Y - valueToSubtract);
